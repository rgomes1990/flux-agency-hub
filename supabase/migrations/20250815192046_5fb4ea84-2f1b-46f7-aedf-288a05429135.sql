...
CREATE POLICY "Users can view their own content padarias data" 
ON public.content_padarias_data 
FOR SELECT 
USING (true);

CREATE POLICY "Users can create their own content padarias data" 
ON public.content_padarias_data 
FOR INSERT 
WITH CHECK (true);

CREATE POLICY "Users can update their own content padarias data" 
ON public.content_padarias_data 
FOR UPDATE 
USING (true);

CREATE POLICY "Users can delete their own content padarias data" 
ON public.content_padarias_data 
FOR DELETE 
USING (true);
